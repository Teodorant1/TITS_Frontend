...
function App(props) {
  ...
  function handlepaloki1(event) {
    ...
    axios.post(ipAddress, text1).catch((error) => console.log(error));
  }
    ...
    return (
      <div class="p-3 mb-2 bg-info text-white">
        <div class="flex-container">
          <h1>
            {" "}
            Welcome to Teodorant Insanity Topic Simulator v6, this game is
            inspired by Forks in the timeline, so it basically plays like that
            minus the bonus cards. Rules:
            https://www.boardgamecapital.com/game_rules/forks-in-the-timeline.pdf
          </h1>
        </div>
        ...
        <div class="flex-container">
          <img
            src="https://i.imgur.com/DNAXf01.png"
            class="img-fluid"
  ...
  function Display() {
            ...
            <div class="flex-container">
              <form>
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label htmlFor="Player Password">
                      <h1>Player Password</h1>
                    </label>
                    <input
                      type="password"
                      className="form-control"
    ...
    return (
      <div className="MatchInfo">
        <Gameinfo
          gameid1={gameid}
          gamepassword1={gamepassword}
          playername1={playername}
          playerpassword1={playerpassword}
          visibility={paloki}
        />
        ...
        <div class="flex-container">
          ...
          <div class={paloki1}>
            {" "}
            <button
              onClick={handleEnterbutton1}
              type="submit"
              class="btn btn-primary"
            >
              {" "}
              Summon the answer button and animations{" "}
            </button>{" "}
          </div>{" "}
        </div>

        <div class={paloki}>
          <div class="flex-container bg-light p-2 text-dark bg-opacity-75">
            {" "}
            <form>
              <div class="form-group">
