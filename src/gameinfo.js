    ...
    <div>
      <div class={toggletable}>
        ...
        <div>
          <div
            style={{ margin: 20 }}
            class="flex-container bg-light p-2 text-dark bg-opacity-75"
          >
          ...
          <table className="table">
            <thead>
              <tr>
                <th>
                  {" "}
                  <div class="bg-light p-2 text-dark bg-opacity-75">Player</div>
                </th>
                <th>
                  <div class="bg-light p-2 text-dark bg-opacity-75">Score</div>
                </th>
                <th>
                  <div class="bg-light p-2 text-dark bg-opacity-75">Answer</div>
                </th>
                <th></th>
              </tr>
            </thead>
      ...
      <div style={{ justifyContent: "center" }} class="flex-container">
        {" "}
        <div class={toggleteleport}>
          <button
            onClick={() => {
              handleEnterbutton("swag");
            }}
            type="submit"
            class="btn btn-danger"
          >
            Click here to teleport to your table and start playing
          </button>
        </div>{" "}
      </div>
    </div>
